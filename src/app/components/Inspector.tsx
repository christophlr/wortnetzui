  ...
  return (
    <div className="w-[268px] bg-zinc-900 border-r border-zinc-800 flex flex-col shrink-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <Accordion.Root type="multiple" defaultValue={['text', 'colors', 'style', 'physics']}>
          ...
          {/* CAMERA */}
          <AccSection value="camera" label="Kamera" color="cyan">
          ...
          <AccSection value="colors" label="Farben" color="purple">
            ...
            <div className="mt-4 space-y-3">
              <SliderParam
                ...
                color="purple" kfs={kfs} onToggle={toggle} min={30} max={100}
                displayFn={v => v[0] + '%'}
              />
              <SliderParam
                kfKey="lightness" label="Helligkeit" value={lightness} onChange={setLightness}
                color="purple" kfs={kfs} onToggle={toggle} min={40} max={80}
                displayFn={v => v[0] + '%'}
              />
            </div>
          </AccSection>
          ...
          {/* PHYSICS */}
          <AccSection value="physics" label="Physik" color="orange">
            <div className="space-y-3">
              <SliderParam
